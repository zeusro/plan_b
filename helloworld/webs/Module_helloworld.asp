	...
	<script>
		...
		function get_dbus_data() {
			...
			$.ajax({
				...
				dataType: "text",   // 改为 text，不让 jQuery 自动解析
				cache: false,
				async: false,
				success: function (data) {
					let json;
					try {
						json = JSON.parse(data);   // 手动解析
					} catch (e) {
						console.error("JSON parse error:", e, data);
						// alert("返回数据不是合法的 JSON");
						// return;
						isJson = false
					}
					if (isJson) {
						db_ss = json.result[0];
						db_scarch = json.result[1];
						conf2obj(db_ss);
					}
					generate_node_info();
					refresh_options();
					...
					ss_node_sel();
					version_show();
					if (isJson && db_ss["ss_failover_enable"] == "1") {
						get_ss_status_back();
					} else {
						get_ss_status_front();
					}
				...
				error: function (xhr, textStatus, errorThrown) {
					...
					alert("skipd数据读取错误！错误信息：" + xhr.responseText);
				}
				, timeout: 0
			});
		}
									...
									<tr>
										<td bgcolor="#4D595D" colspan="3" valign="top">
											...
											<div class="formfonttitle">
												<% nvram_get("modelname"); %> ShadowSocksR Plus插件
											</div>
											...
											<div class="SimpleNote" id="head_illustrate">本插件是支持<a
													...
													href="https://github.com/v2ray/v2ray-core"
													target="_blank"><em><u>V2Ray</u></em></a>、<a target="_blank"
													href="https://github.com/trojan-gfw/trojan"><em><u>Trojan</u></em></a>
												等协议</div>
											<!-- this is the popup area for process status -->
											<div id="detail_status" class="content_status"
												style="box-shadow: 3px 3px 10px #000;margin-top: -20px;display: none;">
												<div class="user_title">【ShadowSocksR Plus】状态检测</div>
												<div style="margin-left:15px">
													<i>&nbsp;&nbsp;目前本功能支持ss相关进程状态和iptables表状态检测。</i>
												</div>
												<div
											...
											<div id="ssf_status_div" class="content_status"
												style="box-shadow: 3px 3px 10px #000;margin-top: -20px;display: none;margin-left:0px;width:748px;">
												...
												<div
													style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
													<input class="button_gen" type="button"
														onclick="download_SS_node(6);" value="下载日志">
													<input class="button_gen" type="button"
											...
											<div id="ssc_status_div" class="content_status"
												style="box-shadow: 3px 3px 10px #000;margin-top: -20px;display: none;margin-left:0px;width:748px;">
												...
												<div
													style="margin-top:5px;padding-bottom:10px;width:100%;text-align:center;">
													<input class="button_gen" type="button"
														onclick="download_SS_node(7);" value="下载日志">
													<input class="button_gen" type="button"
														...
														<td colspan="2">
															...
															<div
																...
																<a type="button" class="ss_btn" target="_blank"
																	href="https://github.com/zusterben/plan_b">更新日志</a>
															</div>
															<div
													...
													<tr>
														<td cellpadding="0" cellspacing="0" style="padding:0" border="1"
															...
															<input id="show_btn5" class="show-btn5"
																style="cursor:pointer" type="button" value="KCP加速" />
											...
											<div id="vpnc_settings" class="contentM_qis pop_div_bg">
												<table class="QISform_wireless" border="0" align="center"
													...
													<tr style="height:32px;">
														<td>
															<table width="100%" border="0" align="left" cellpadding="0"
																cellspacing="0" class="vpnClientTitle">
																<tr>
																	<td width="25%" align="center" id="ssTitle"
																		onclick="tabclickhandler(0);">添加SS账号</td>
																	<td width="25%" align="center" id="ssrTitle"
																		onclick="tabclickhandler(1);">添加SSR账号</td>
																	<td width="25%" align="center" id="v2rayTitle"
																		onclick="tabclickhandler(2);">添加V2Ray配置</td>
																	<td width="25%" align="center" id="TrojanTitle"
																		onclick="tabclickhandler(3);">添加Trojan配置</td>
																</tr>
															</table>
														</td>
													</tr>
													<tr>
														<td>
															<div>
																<table id="table_edit" width="100%" border="1"
											...
											<div id="tablet_2" style="display: none;">
												<table id="table_failover" style="margin:-1px 0px 0px 0px;" width="100%"
												...
												<div align="center" style="margin-top: 10px;">
													<input class="button_gen" type="button" onclick="save()"
														value="保存&amp;应用">
													<input style="margin-left:10px" id="ss_failover_save"
														class="button_gen" onclick="save_failover()" type="button"
														value="保存本页设置">
												</div>
											...
											<div id="tablet_7" style="display: none;">
												...
												<div id="ACL_note" style="margin:10px 0 0 5px">
													...
													<div><i>4&nbsp;&nbsp;如果为使用的节点配置了KCP协议，因为它们不支持udp，所以不能控制主机走游戏模式。</i>
													</div>
													<div>
											...
											<div id="tablet_8" style="display: none;">
												<table id="table_addons" style="margin:-1px 0px 0px 0px;" width="100%"
													border="1" align="center" cellpadding="4" cellspacing="0"
													bordercolor="#6b8fa3" class="FormTable">
													<script type="text/javascript">
